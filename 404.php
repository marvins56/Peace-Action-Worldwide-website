...
<title>peace and action WorldWide</title>
    ...
    <body>
        ...
        <!-- ERROR PAGE -->
        <section class="section bg-home" style="background-image: url('images/success.gif');">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 text-center error-page">
                                ...
                                <h4 class="mt-3 text-white">TRANSACTION SUCCESSFULL</h4>
                                <h1 class="text-white"> SUCCESSFULL</h1>
                                <h4 class="text-white">Thanks for your donation</h4>
                                <p class="text-white mt-3">Use the navigation above or the button below to get back and track.</p>
                                <a href="index.php" class="btn btn-custom mt-4">Go Back Home</a>
                            </div>
                        </div>
                    </div> <!-- end container -->
                </div>
