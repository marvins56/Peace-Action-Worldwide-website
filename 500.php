...
<head>
    ...
    <body>
        ...
        <!-- ERROR PAGE -->
        <section class="section bg-home" style="background-image: url('images/fail.gif');">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 text-center error-page">
                                ...
                                <h4 class="mt-3 text-white">TRANSACTION FAILED</h4>
                                <h1 class="text-white">FAILED</h1>
                                <h4 class="text-white">Please  T ry Back Again Later</h4>
